...
const GlobalStyles = createGlobalStyle`
    ...
    :root {
        ...
        --color-water: hsl(210, 56% , 58%);
        --color-waterDark: hsl(210, 56% , 38%);
        ...
        --color-snooze: hsla(35, 100%, 70%);
        --color-snoozeDark: hsla(35, 100%, 60%);
        --color-soil: hsl(27, 100% , 87%);
        --color-soilHighlight: hsla(27, 65% , 87%, 0.5);
        --color-delete: hsla(11,80%,80%);
        --color-deleteDark: hsla(11,80%,60%);
